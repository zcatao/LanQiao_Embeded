...
//电阻屏芯片连接引脚
#define T_CLK_CLR     GPIO_ResetBits(GPIOA, GPIO_Pin_3)
#define T_CLK_SET     GPIO_SetBits(GPIOA, GPIO_Pin_3)
#define TDIN_CLR      GPIO_ResetBits(GPIOA, GPIO_Pin_5)
#define TDIN_SET      GPIO_SetBits(GPIOA, GPIO_Pin_5)
#define T_CS_CLR      GPIO_ResetBits(GPIOA, GPIO_Pin_4) 
#define T_CS_SET      GPIO_SetBits(GPIOA, GPIO_Pin_4)
#define DOUT          GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_6)
#define PEN           GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_7)
